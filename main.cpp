...
int main() {
    try { // Blok przechwytujacy wyjatki rzucane z klas
        ...
        // przekazujemy dynamicznie zmienna 'n' wczytane z pliku
        DistanceGraph* g = new DistanceGraphExt(n);

        // 4. Za pomoca petli wczytujemy reszte macierzy i uzupelniamy graf
        ...
        file.close(); // Zamykamy strumienb pliku, dane sa juz bezpieczne w obiekcie grafu
